  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="max-w-xl w-full fixed left-1/2 top-1/2 z-50 grid -translate-x-1/2 -translate-y-1/2 gap-0 border bg-background p-6 shadow-lg sm:rounded-lg"
        ...
        >
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            <Dialog.Title className="text-lg font-semibold mb-2 hidden">
